...
@implementation JIRIssueFieldsAssignee
...
+ (JIRIssueFieldsAssignee *)instanceFromDictionary:(NSDictionary *)aDictionary
{

    JIRIssueFieldsAssignee *instance = [[JIRIssueFieldsAssignee alloc] init];
